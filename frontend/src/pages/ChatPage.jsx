import {Box,Flex,Text,Button,Input,useColorModeValue,SkeletonCircle} from '@chakra-ui/react'
  ...
  return (
    <Box position={"absolute"} left={"50%"} w={{
      ...
      {!selectedConversation._id && (
        <Flex flex={60} borderRadius={"md"} p={2} flexDir={"column"} alignItems={"center"} justifyContent={"center"} height={"400px"}>
