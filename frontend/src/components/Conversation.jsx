  ...
  return (
      ...
      >
       ...
       <Stack direction={"column"} fontSize={"sm"}>
          <Text flexWrap={"700"} display={"flex"} alignItems={"center"}>
          ...
          <Text fontSize={"xs"} display={"flex"} alignItems={"center"} gap={1}>
            ...
            {lastMessage.text.length > 18 ? lastMessage.text.substring(0,18) + '...' : lastMessage.text || <BsImageFill size={20} />}
          </Text>
       </Stack>
      </Flex>
  )
