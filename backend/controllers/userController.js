...
const followUnfollowUser = async(req,res)=>{
  try {
    ...
    if(isFollowing){
      //unfollow user
      // modify current user following, modify followers of userTopModify
    ...
    console.log("Error in folowUnfollowUser ", error.message )
  }
}
...
const getSuggestedUsers = async(req,res)=>{
  try {
    //exclude the current user from suggested users array also exclude current user is already following
    const userId = req.user._id;
